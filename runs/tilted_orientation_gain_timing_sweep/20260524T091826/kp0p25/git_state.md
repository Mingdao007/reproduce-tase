...
- Dirty state: `?? runs/tilted_orientation_gain_timing_sweep/`
- Scope:
  Force-motion feasibility sweep for `e1-cycloid` with time scales `0.05,0.075,0.1`.
- Orientation task:
  mode `force-normal`, priority `linear-primary`, kp `0.25`, angular axis weight `1.0`, angular slack weight `1.0`.
- Orientation gates:
