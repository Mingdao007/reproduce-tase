...
| `duration_s` | `5.0` |
| `sample_count` | `2501` |
| `max_abs_q_rad` | `2.4995864840253907` |
| `max_abs_qdot_rad_s` | `0.6318376969546269` |
| `q_bound_violation_count` | `0` |
| `qdot_bound_violation_count` | `0` |
| `velocity_clamp_fraction` | `0.5613754498200719` |
| `contact_fraction` | `0.273890443822471` |
| `tail_contact_fraction` | `0.0` |
| `task_residual_rms` | `0.08147063929087314` |
| `tail_position_error_mean_m` | `0.0030910509183547244` |
| `tail_orientation_error_mean_rad` | `0.00018635025045757645` |
