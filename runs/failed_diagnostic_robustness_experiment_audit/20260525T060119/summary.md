...
Run root: `/home/andy/reproduce-tase/runs/failed_diagnostic_robustness_experiment_audit/20260525T060119`

- Status: `completed`
- Executed cell count: `3`
- Closed cell count: `0`
- Not-executed cell count: `1`
...
| `positive_fast_timing_0p0075` | `executed_unresolved` | `False` | `runs/failed_diagnostic_robustness_experiment_matrix/20260525T053909/experiments/positive_fast_timing_0p0075/metrics.yaml` |
| `positive_orientation_gate_0p119` | `executed_unresolved` | `False` | `runs/failed_diagnostic_robustness_experiment_matrix/20260525T053909/experiments/positive_orientation_gate_0p119/metrics.yaml` |
