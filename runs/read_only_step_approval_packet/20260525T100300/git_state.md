...
- Commit: `a21cd3ffc29e1ff55743cb155ab11003dd9bfbb2`
- Dirty tree: `True`
- Status:
...
```bash
/usr/bin/python3 scripts/create_read_only_step_approval_packet.py --step-id phase5_orientation_gate_semantics_evidence --packet-id 20260525T100300
```
