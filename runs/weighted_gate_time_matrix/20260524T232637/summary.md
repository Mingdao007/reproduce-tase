...
Run root: `/home/andy/reproduce-tase/runs/weighted_gate_time_matrix/20260524T232637`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `time0p01_gate0p11995:weighted_kp0_normal1` | `weighted_kp0_normal1` | `0.01` | `0.11995` | `8/8` | `1.0` | `0.11956645203696047` | `0.0` | `0.520987929048311` | `0.000991190904368784` |
| `time0p01_gate0p11995:weighted_kp0_normal30` | `weighted_kp0_normal30` | `0.01` | `0.11995` | `8/8` | `1.0` | `0.11956645203696047` | `0.0` | `0.520987929048311` | `0.000991190904368784` |
| `time0p0075_gate0p119:weighted_kp0_normal1` | `weighted_kp0_normal1` | `0.0075` | `0.119` | `7/8` | `0.75` | `0.11954627160547111` | `0.0` | `0.5177926211135458` | `0.0009911909058976187` |
| `time0p0075_gate0p119:weighted_kp0_normal30` | `weighted_kp0_normal30` | `0.0075` | `0.119` | `7/8` | `0.75` | `0.11954627160547111` | `0.0` | `0.5177926211135458` | `0.0009911909058976187` |
| `time0p01_gate0p119:weighted_kp0_normal1` | `weighted_kp0_normal1` | `0.01` | `0.119` | `7/8` | `0.75` | `0.11956645203696047` | `0.0` | `0.520987929048311` | `0.000991190904368784` |
| `time0p01_gate0p119:weighted_kp0_normal30` | `weighted_kp0_normal30` | `0.01` | `0.119` | `7/8` | `0.75` | `0.11956645203696047` | `0.0` | `0.520987929048311` | `0.000991190904368784` |

## Gate Boundary Groups

| group | time scale | pass count | min passing gate | max failing gate | max orientation | max qdot sat |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `gate_boundary_plus1mm_time_0p0075` | `0.0075` | `4/8` | `0.11955` | `0.1195` | `0.11954627160547111` | `0.0` |
| `gate_boundary_plus1mm_time_0p01` | `0.01` | `3/8` | `0.1196` | `0.11955` | `0.11956645203696047` | `0.0` |
...
| `gate_boundary_plus1mm_time_0p0075` | `weighted_kp0_normal1:time_0p0075_gate_0p1194:delta1p000mm` | `False` | `False` | `0/4` | `0.1194` | `0.0075` | `1.0` | `0.11954627160547111` | `0.0` | `e1-cycloid:max_orientation_error_rad; e2-figure-eight:max_orientation_error_rad; e3-circle:max_orientation_error_rad; e4-cardioid:max_orientation_error_rad` |
...
| `gate_boundary_plus1mm_time_0p01` | `weighted_kp0_normal1:time_0p01_gate_0p1194:delta1p000mm` | `False` | `False` | `0/4` | `0.1194` | `0.01` | `1.0` | `0.11956645203696047` | `0.0` | `e1-cycloid:max_orientation_error_rad; e2-figure-eight:max_orientation_error_rad; e3-circle:max_orientation_error_rad; e4-cardioid:max_orientation_error_rad` |
