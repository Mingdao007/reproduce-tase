...
| Implement tests before trusting plots | `scripts/run_tests.sh` used throughout; latest v44 validation was `79 passed in 2.05s`; `git diff --check` passed | Done for current code |
