...
- Continue UR10e adapted work by executing only a safe read-only SOP subset
  ...
  simulation/paper-platform work identified by the v95-v114 blocker audits.
  The next strict-feasibility probe should stop treating Stage A as a
  command-limited instantaneous velocity problem and test an explicit path or
  terminal constraint formulation.
  Keep strict paper-equivalent setup, v38 trajectory-after-relaxed-setup, and
  v63-v114 diagnostic staged labels separate.
