...
- Continue UR10e adapted work by investigating the positive-side terminal
  orientation gate/model convention. Keep strict paper-equivalent setup, v38
  trajectory-after-relaxed-setup, and v63-v68 diagnostic staged labels
  separate.
