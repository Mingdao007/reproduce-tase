...
- Continue UR10e adapted work by executing only a safe read-only SOP subset
  ...
  offline simulation/paper-platform work identified by the v95-v123 blocker
  and review audits.
  ...
  v63-v123 diagnostic staged labels separate.
