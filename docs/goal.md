...
- Continue UR10e adapted work by moving to the harder `+1.0 mm` faster-timing
  and tighter-orientation sensitivity limits, unless the project intentionally
  stops the qdot012 branch at the recovered diagnostic matrix. Keep strict
  paper-equivalent setup, v38 trajectory-after-relaxed-setup, and v63-v75
