...
- Continue UR10e adapted work by deciding whether to fold the `18.035 s`
  qdot012 duration margin into a compact positive stitched recovery matrix or
  move to the harder `+1.0 mm` faster-timing/orientation sensitivity limits.
  Keep strict paper-equivalent setup, v38 trajectory-after-relaxed-setup, and
  v63-v74 diagnostic staged labels separate.
