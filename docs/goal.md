...
- Continue UR10e adapted work by stress-testing the recovered planar-primary
  formulation against faster timing and the tighter `0.119 rad` orientation
  gate before claiming anything stronger than diagnostic recovery. Keep strict
