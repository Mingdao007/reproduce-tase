...
- Continue UR10e adapted work by testing whether perturbation-aware Stage A
  path reoptimization or margin-aware timing can recover the v64
  base-z/contact and qdot failures. Keep strict paper-equivalent setup, v38
  trajectory-after-relaxed-setup, and v63/v64 diagnostic staged labels
  separate.
